...
CREATE POLICY "Allow authenticated delete potential_clients" ON public.potential_clients FOR DELETE TO authenticated USING (true);`);
      ...
      {/* Top Controls Header */}
      <div className="p-4 border-b border-amber-600/40 dark:border-amber-500/30 bg-amber-600 dark:bg-gray-900 flex-shrink-0 rounded-t-2xl">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
            <div className="flex bg-white dark:bg-gray-900 rounded-xl border border-slate-200 dark:border-gray-800 flex-1 sm:flex-none justify-center overflow-hidden shadow-sm h-[48px] items-center">
              <button
                ...
                className="flex-1 sm:flex-none text-xs font-semibold px-4 py-2 hover:bg-slate-50 dark:hover:bg-zinc-800 text-slate-700 dark:text-zinc-300 border-r border-slate-200 dark:border-gray-800 transition-colors h-full flex items-center justify-center"
              >
                CSV
              </button>
              <button
              ...
              <button
                ...
                className="flex-1 sm:flex-none text-xs font-semibold px-4 py-2 hover:bg-slate-50 dark:hover:bg-zinc-800 text-slate-700 dark:text-zinc-300 transition-colors h-full flex items-center justify-center"
              >
                PDF
              </button>
            </div>
            ...
            {canEdit && (
              <button
                ...
                className="text-xs font-semibold bg-white hover:bg-slate-50 text-amber-700 dark:bg-yellow-500 dark:text-black dark:hover:bg-yellow-400 px-4 py-2.5 rounded-xl transition-all shadow-sm w-full sm:w-auto h-[48px] flex items-center justify-center gap-1.5 border border-amber-200 dark:border-yellow-500/50"
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-12 gap-3">
          ...
          <div className="sm:col-span-6 relative">
            <input
              ...
              className="w-full px-4 py-3 bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 rounded-xl text-xs text-slate-900 dark:text-white focus:outline-none focus:border-amber-500 transition-all h-[48px] shadow-sm"
            />
          </div>
          ...
          <div className="sm:col-span-3 relative">
            <select
              ...
              className="w-full bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 text-slate-700 dark:text-zinc-300 text-xs font-semibold rounded-xl py-3 pl-4 pr-10 focus:outline-none focus:border-amber-500 cursor-pointer h-[48px] shadow-sm appearance-none"
            >
        ...
        <table className="w-full min-w-[1100px] text-left border-collapse whitespace-nowrap text-xs md:text-sm">
          <thead>
            <tr className="bg-slate-50 dark:bg-gray-900/90 border-b border-slate-200 dark:border-gray-800">
              ...
              <th className="px-4 py-3.5 font-semibold text-slate-500 dark:text-zinc-400 sticky right-0 bg-slate-50 dark:bg-gray-900 z-20 shadow-sm text-left">
                    ...
                    <td className="px-4 py-3.5 text-left whitespace-nowrap sticky right-0 bg-white dark:bg-black group-hover:bg-slate-50 dark:group-hover:bg-zinc-900 transition-colors shadow-[-4px_0_10px_-4px_rgba(0,0,0,0.06)] z-10">
                      <div className="flex items-center justify-start gap-1.5">
                        <button
                          ...
                          className="h-7 px-2.5 flex items-center justify-center rounded-lg bg-cyan-600 hover:bg-cyan-700 text-white text-xs font-semibold transition-all shadow-sm"
                          title="View Profile"
                        >
                        ...
                        {canEdit && (
                          <>
                            <button
                              ...
                              className="h-7 px-2.5 flex items-center justify-center rounded-lg bg-white hover:bg-slate-50 text-slate-700 dark:bg-gray-800 dark:text-zinc-200 dark:hover:bg-zinc-700 border border-slate-200 dark:border-gray-700 text-xs font-semibold transition-all shadow-sm"
                              title="Edit Client"
                            >
                            ...
                            {client.status !== 'Converted' && (
                              <button
                                ...
                                className="h-7 px-2.5 flex items-center justify-center rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold transition-all shadow-sm"
                                title={t('clients', 'convertToActiveClient', lang)}
                              >
                                {lang === 'bm' ? '+ Tukar Klien' : '+ Convert'}
                              </button>
                            )}
