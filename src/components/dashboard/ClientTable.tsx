                  ...
                  <tr key={rowId} className="hover:bg-slate-50/50 dark:hover:bg-zinc-900/50 transition-colors group relative">
                    ...
                    {viewMode === 'standard' ? (
                      <>
                        ...
                        <td className="px-4 py-3.5 font-bold text-slate-805 dark:text-white truncate max-w-[120px] md:max-w-[150px]">{client.NAME}</td>
                        <td className="px-4 py-3.5 text-slate-700 dark:text-zinc-300 font-mono">{client["PHONE NUMBER"]}</td>
                        <td className="px-4 py-3.5 text-slate-700 dark:text-zinc-300 font-mono">{client["IC NUMBER"]}</td>
                        ...
                        <td className="px-4 py-3.5">
                          <span className={`text-[10px] font-semibold px-2.5 py-0.5 rounded-md border tracking-wide uppercase
                            ${String(client["CASE STATUS"]).includes('COMPLETED') ? 'bg-emerald-50 text-emerald-800 border-emerald-100 dark:bg-emerald-950/20 dark:text-emerald-400 dark:border-emerald-900/30' 
                            : String(client["CASE STATUS"]).includes('DROPPED') ? 'bg-rose-50 text-rose-800 border-rose-105 dark:bg-rose-955/20 dark:text-rose-400 dark:border-rose-900/30' 
